...
export interface CartesiMathV2Interface extends Interface {
    getFunction(nameOrSignature: "clz" | "ctz" | "getLog2Floor" | "getLog2TableTimes1M" | "isPowerOf2" | "log2ApproxTimes1M"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "log2ApproxTimes1M", values: [BigNumberish]): string;
...
export interface CartesiMathV2 extends BaseContract {
    ...
    getFunction(nameOrSignature: "log2ApproxTimes1M"): TypedContractMethod<[_num: BigNumberish], [bigint], "view">;
    filters: {};
}
//# sourceMappingURL=CartesiMathV2.d.ts.map