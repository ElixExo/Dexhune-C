...
export interface MockOracleInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "setPrice", values: [string]): string;
...
export interface MockOracle extends BaseContract {
  ...
  setPrice: TypedContractMethod<[price: string], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[price: string], [void], "nonpayable">;
