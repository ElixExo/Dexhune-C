...
export interface DexhuneExchangeInterface extends Interface {
  getFunction(nameOrSignature: "parseString"): FunctionFragment;
...
export interface DexhuneExchange extends BaseContract {
  ...
  parseString: TypedContractMethod<[value: string], [bigint], "nonpayable">;
  ...
  ): TypedContractMethod<[value: string], [bigint], "nonpayable">;
